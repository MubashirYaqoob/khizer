...
const WHATSAPP_NUMBER = "923172774216";
          ...
          >
            ...
            <div className="bg-white px-4 py-4">
              <a
                ...
                className="flex items-center justify-center gap-2 w-full bg-[#25D366] hover:bg-[#20ba5a] text-white text-sm font-semibold py-3 rounded-xl transition-colors duration-200"
              >
