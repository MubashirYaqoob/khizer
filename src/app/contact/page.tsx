        ...
        <div className="bg-white p-8 md:p-12 border border-outline/10 shadow-sm max-w-2xl mx-auto text-center space-y-10">
          ...
          <div className="pt-10 border-t border-outline/10">
            ...
            <div className="flex justify-center gap-6">
              <a href="https://www.instagram.com/al_hudafabricspk?igsh=aDNmZTZyaDQwOWRi" target="_blank" rel="noopener noreferrer" className="w-12 h-12 flex items-center justify-center border border-outline/30 rounded-full hover:bg-gold hover:text-white hover:border-gold transition-all text-primary" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/share/17g7yB2BxY/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 flex items-center justify-center border border-outline/30 rounded-full hover:bg-gold hover:text-white hover:border-gold transition-all text-primary" aria-label="Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
